...
public class Md5CaculateUtil {
    ...
    public static String getHash(String src) throws IOException, NoSuchAlgorithmException{
        
//      File f = new File(fileName);
      
      InputStream ins = new ByteArrayInputStream(src.getBytes("GB18030"));
...
//      return toHexString(md5.digest());
    ...
    public static String getHash(File f,String hashType) throws IOException, NoSuchAlgorithmException{
