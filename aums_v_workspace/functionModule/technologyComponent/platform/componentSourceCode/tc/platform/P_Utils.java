...
public class P_Utils {
	...
	@Returns(returns = { @Return(id = "0", desp = "失败"),
			@Return(id = "1", desp = "成功") })
	@Component(label = "UUID", style = "判断型", type = "同步组件", comment = "获得UUID", date = "2016-09-12 06:48:22")
	...
	@OutParams(param = { @Param(name = "dict", comment = "返回字典", type = cn.com.agree.afa.svc.javaengine.context.JavaDict.class) })
	@Returns(returns = { @Return(id = "0", desp = "失败"),
			@Return(id = "1", desp = "成功") })
	@Component(label = "合并字典", style = "判断型", type = "同步组件", comment = "合并两个数据字典", date = "2016-09-20 06:51:06")
	public static TCResult P_mergeDict(JavaList dict1, JavaList dict2,
			String dictName1, String dictName2) {
