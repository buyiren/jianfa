...
public class P_Logger {
	...
	public static TCResult info(Object strOrList) {
		...
		if (strOrList instanceof JavaList) {
			...
			for (int i = 0; i < list.size(); i++) {
				AppLogger.info(String.valueOf(list.getItem(i)));
			}
		} else {
			AppLogger.info(String.valueOf(strOrList));
		}
	...
	public static TCResult debug(Object strOrList) {
		...
		if (strOrList instanceof JavaList) {
			JavaList list = (JavaList) strOrList;
			for (int i = 0; i < list.size(); i++) {
				AppLogger.debug(String.valueOf(list.getItem(i)));
			}
		} else {
			AppLogger.debug(String.valueOf(strOrList));
		}
		return TCResult.newSuccessResult();
	}
	...
	public static TCResult trace(Object strOrList) {
		...
		if (strOrList instanceof JavaList) {
			JavaList list = (JavaList) strOrList;
			for (int i = 0; i < list.size(); i++) {
				AppLogger.trace(String.valueOf(list.getItem(i)));
			}
		} else {
			AppLogger.trace(String.valueOf(strOrList));
		}
		return TCResult.newSuccessResult();
	}
	...
	public static TCResult error(Object strOrList) {
		...
		if (strOrList instanceof JavaList) {
			JavaList list = (JavaList) strOrList;
			for (int i = 0; i < list.size(); i++) {
				AppLogger.error(String.valueOf(list.getItem(i)));
			}
		} else {
			AppLogger.error(String.valueOf(strOrList));
		}
		return TCResult.newSuccessResult();
	}
