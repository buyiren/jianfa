...
public class P_CodecTools {
	 ...
	 */
	@InParams(param = { 
			@Param(name = "sourceString", comment = "解码前字符串", type = java.lang.String.class), 
			@Param(name = "charset", comment = "解码前字符串编码", type = java.lang.String.class) })
	...
	public static TCResult b64Decode(String sourceString,String charset) {
		try {
			if (sourceString == null) {
